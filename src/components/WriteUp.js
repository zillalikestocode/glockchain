	...
	return (
		<div className=" md:px-10 p-5 writeup-bg w-full">
			...
			<div className="flex mt-5 w-full mb-24">
				<Button text="Get Started" styles="bg-blue-500 rounded-lg mr-4 text-white p-3 px-4 md:text-xl w-full lg:w-fit lg:text-[0.9em] font-medium"/>
				<Button text="Log In"  styles="bg-white p-3 px-4 rounded-lg md:text-xl w-full lg:w-fit lg:text-sm font-medium"/>
			</div>
		</div>
	)
}
